<template>
  <div class="space-y-6">
    ...
    <div class="bg-white p-4 sm:p-6 rounded-lg shadow flex flex-col md:flex-row md:items-center md:justify-between gap-4">
      <div>
        <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Laporan Pemesanan Ruangan</h1>
        <p class="text-xs sm:text-sm text-gray-500 mt-1">Analisa & statistik penggunaan ruangan</p>
      </div>
