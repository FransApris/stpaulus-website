<template>
  <div class="p-6 max-w-5xl mx-auto">
    ...
    <form v-else-if="entry" @submit.prevent="handleSubmit" class="bg-white rounded-lg shadow p-6 space-y-6">
      ...
      <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div class="flex items-start gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-blue-700 mt-1">Kategori ini dipilih otomatis berdasarkan profil pembuat dan <strong>tidak dapat diubah</strong> untuk menjaga integritas data.</p>
          </div>
        </div>
      </div>
      ...
      <!-- Kategori (Disabled) -->
      <div>
        <label class="block text-sm font-medium mb-2">Kategori * <span class="text-xs text-gray-500">(Tidak dapat diubah)</span></label>
        <select v-model="form.category_id" required disabled class="w-full border rounded-lg px-4 py-2 bg-gray-100 cursor-not-allowed">
