                ...
                <tr v-for="agenda in paginatedAgendas" :key="agenda.id"
                  ...
                  <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                    <NuxtLink :to="`/admin/announcements?from_agenda=1&agenda_id=${agenda.id}&agenda_title=${encodeURIComponent(agenda.title)}&event_date=${agenda.start_date?.slice(0,10)}&event_time=${agenda.start_date?.slice(11,16) || ''}`"
                      title="Buat Pengumuman dari Agenda"
                      class="text-indigo-600 hover:text-indigo-900 mr-4 p-1 inline-flex items-center">
              ...
              <div class="pr-10">
                ...
                <div class="grid grid-cols-1 gap-2.5 text-sm text-gray-700 mb-5 bg-gray-50 p-3 rounded-lg border border-gray-100">
                  <div class="flex items-start gap-2.5">
                    <svg class="w-5 h-5 mt-0.5 flex-shrink-0 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                  ...
                  <div class="flex items-start gap-2.5">
                    <svg class="w-5 h-5 mt-0.5 flex-shrink-0 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                  ...
                  <div v-if="agenda.liturgy_type_name" class="flex items-start gap-2.5">
                    <span class="w-5 h-5 mt-0.5 flex-shrink-0 text-gray-400 flex items-center justify-center font-bold">{{ agenda.liturgy_type_icon }}</span>
