<template>
  <div>
    ...
    <div v-else>
      <div
        class="min-h-screen pt-16 bg-gray-50"
        style="
      ...
      >
        ...
        >
          <div
            class="container mx-auto px-4 sm:px-[5%] md:px-[7%] lg:px-[10%]"
            style="
              overflow-x: hidden !important;
          ...
          >
            ...
            <div class="text-center mb-12">
              <h1 class="text-4xl font-cinzel text-[#882f1d] mb-4">
                Pemesanan Ruangan
              </h1>
            ...
            <div v-if="!isLoggedIn" class="max-w-2xl mx-auto mb-12">
              ...
              >
                ...
                <h2 class="text-3xl font-cinzel font-bold text-[#882f1d] mb-4">
                  Login Diperlukan
                </h2>
                <p class="text-lg text-gray-700 mb-6">
                  Silakan login terlebih dahulu untuk mengakses pemesanan ruang
                  paroki.
                </p>
                <div class="bg-white/60 rounded-lg p-4 mb-6">
                  <p class="text-sm text-gray-600 mb-3">
                    <strong>Belum punya akun?</strong> Login di beranda untuk
                    mendapatkan akses ke:
                  </p>
                  <ul
                    class="text-left text-sm text-gray-700 space-y-2 max-w-md mx-auto"
                  >
            ...
            <div v-else>
              <!-- User Info Card -->
              <div
                class="mb-8 bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden"
              >
                <div
                  class="bg-gradient-to-r from-[#882f1d] to-[#b8442a] px-6 py-4 flex items-center gap-3"
                >
                  <div
                  ...
                  <div class="min-w-0">
                    <p
                      class="text-white font-semibold text-base leading-tight truncate"
                    >
                ...
                >
                  <div class="flex flex-col sm:flex-row gap-3 sm:gap-6">
                    <div class="flex items-center gap-2">
                      <span
                        class="inline-flex items-center justify-center w-7 h-7 rounded-lg bg-orange-50 flex-shrink-0"
                      >
                        <svg
                      ...
                      <div>
                        ...
                        <p
                          ...
                          :class="
                            ...
                            userQuota.monthly_count >= userQuota.max_allowed
                              ? 'text-red-600 font-bold'
                              : userQuota && userQuota.is_unlimited
                                ? 'text-green-600'
                                : 'text-gray-800'
                          "
                        >
                          ...
                          <template v-else-if="userQuota.is_unlimited">
                            Pemakaian: {{ userQuota.monthly_count }}
                          ...
                          <template v-else
                            >Pemakaian: {{ userQuota.monthly_count }} /
                            {{ userQuota.max_allowed }}</template
                          >
                        </p>
                        <p
                          v-if="userQuota && userQuota.period"
              ...
              <!-- Petunjuk Penggunaan -->
              <div
                class="mb-8 bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg"
              >
                <div class="flex items-start">
                  ...
                  <div>
                    <h3 class="text-lg font-semibold text-blue-900 mb-3">
                      Cara & Panduan Pemesanan Ruangan
                    </h3>
                    <ol class="space-y-2.5 text-blue-800 text-sm">
                      <li class="flex items-start">
                        <span class="font-bold mr-2">1.</span>
                        <span
                          ><strong>Pilih Ruangan:</strong> Klik tombol "Pesan"
                          pada ruangan yang tersedia di bawah</span
                        >
                      </li>
                      <li class="flex items-start">
                        <span class="font-bold mr-2">2.</span>
                        <span
                          ><strong>Isi Detail:</strong> Masukkan nama acara,
                          tanggal, jam mulai, dan jam selesai.</span
                        >
                      </li>
                      <li class="flex items-start">
                        <span class="font-bold mr-2">3.</span>
                        <span
                          ><strong>Pemesanan Berulang (Rutin):</strong> Untuk
                          kegiatan rutin (misal rapat mingguan), centang
                          <em>"Pemesanan Berulang"</em> dan pilih frekuensi
                          (Mingguan, 2-Mingguan, atau Bulanan) serta batas
                          tanggal pengulangan.</span
                        >
                      </li>
                      <li class="flex items-start">
                        <span class="font-bold mr-2">4.</span>
                        <span
                          ><strong>Konfirmasi:</strong> Klik
                          <em>"Konfirmasi Pemesanan"</em> setelah seluruh data
                          terisi dengan benar.</span
                        >
                      </li>
                      <li class="flex items-start">
                        <span class="font-bold mr-2">5.</span>
                        <span
                          ><strong>Notifikasi In-App & Email:</strong> Perubahan
                          status pemesanan (<span
                          ...
                          <span class="font-semibold text-gray-700"
                            >DIBATALKAN</span
                          >) akan dikirimkan otomatis ke
                          <strong>Email Akun Anda</strong> serta muncul di
                          <strong>Ikon Lonceng Notifikasi (Bell)</strong> pada
                          Navbar atas.</span
                        >
                      </li>
                      <li class="flex items-start">
                        ...
                        <span
                          ><strong>Batalkan (Wajib Alasan):</strong> Anda dapat
                          membatalkan pemesanan PENDING dengan menekan tombol
                          <em>"Batalkan"</em> dan mengisi alasan pembatalan pada
                          form konfirmasi. Konfirmasi pembatalan juga akan
                          dikirimkan via email.</span
                        >
                      </li>
                    </ol>
                    <div class="mt-4 pt-4 border-t border-blue-200">
                      ...
                      >
                        ...
                        <span>
                          ...
                          Anda sudah memiliki {{ userQuota.monthly_count }} dari
                          {{ userQuota.max_allowed }} pemesanan di bulan
                          <strong>{{ userQuota.period }}</strong
                          >. Kuota akan direset bulan depan.
                        </span>
                      </div>
                      <!-- Info kuota tidak terbatas untuk DPP/BGKP -->
                      <div
                        v-else-if="userQuota && userQuota.is_unlimited"
                      ...
                      >
                        ...
                        <span
                          >Akun Anda (DPP/BGKP) tidak memiliki batas pemesanan
                          bulanan.</span
                        >
                      </div>
                      <p class="text-sm text-blue-700">
                        <strong>Tips:</strong> Cek kotak masuk Email Anda atau
                        pantau notifikasi lonceng di Navbar atas. Status
                        pemesanan akan berubah menjadi
                        <span
                          class="inline-block px-2 py-0.5 bg-green-100 text-green-800 rounded text-xs font-semibold"
                          >DISETUJUI</span
                        >
                        atau
                        <span
                          class="inline-block px-2 py-0.5 bg-red-100 text-red-800 rounded text-xs font-semibold"
                          >DITOLAK</span
                        >
              ...
              <!-- ── Kalender Mingguan ──────────────────────────────────────────── -->
              <div
                class="bg-white rounded-2xl border border-gray-200 shadow-sm p-4 sm:p-6 mb-10"
              >
                <!-- Header & Week Controls -->
                <div
                  class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-5 pb-4 border-b border-gray-100"
                >
                  <div>
                    <div class="flex items-center gap-2">
                      <span class="text-2xl">🗓️</span>
                      <h2
                        class="text-xl sm:text-2xl font-cinzel font-bold text-gray-900"
                      >
                        Jadwal Mingguan Ruangan
                      </h2>
                    </div>
                    <p class="text-xs sm:text-sm text-gray-500 mt-1">
                      Cek jadwal pemakaian dan ketersediaan ruangan setiap hari
                    </p>
                  </div>

                  <!-- Week Navigation Bar -->
                  <div
                    class="flex items-center justify-between sm:justify-end gap-1.5 sm:gap-2 bg-gray-50 p-1.5 rounded-xl border border-gray-200"
                  >
                    <button
                    ...
                    <span
                      class="text-xs sm:text-sm font-semibold text-gray-800 px-2 text-center whitespace-nowrap"
                    >
                      {{
                        weeklyData
                          ? `${formatShortDate(weeklyData.week_start)} – ${formatShortDate(weeklyData.week_end)}`
                          : "Memuat..."
                      }}
                    </span>
                    <button
                ...
                <div
                  v-if="weeklyLoading"
                  class="flex items-center justify-center py-12 text-gray-500 gap-3"
                >
                  <svg
                    class="w-6 h-6 animate-spin text-[#882f1d]"
                    fill="none"
                    viewBox="0 0 24 24"
                  >
                    <circle
                ...
                <div
                  v-if="weeklyData"
                  class="overflow-x-auto rounded-xl border border-gray-200 hidden md:block"
                >
                  <table class="w-full text-xs border-collapse">
                    <thead>
                      <tr class="bg-gray-50">
                        <th
                          class="text-left px-3 py-3 text-gray-600 font-semibold border-b border-gray-200 min-w-[130px]"
                        >
                          Ruangan
                        </th>
                        <th
                          ...
                          :class="
                            isToday(day)
                              ? 'bg-amber-50 text-[#882f1d]'
                              : 'text-gray-700'
                          "
                        >
                          <div
                            class="uppercase tracking-wider text-[11px] font-bold"
                          >
                            {{ getDayName(day) }}
                          </div>
                          <div
                            ...
                            :class="
                              isToday(day) ? 'text-[#882f1d]' : 'text-gray-500'
                            "
                          >
                            {{ formatShortDate(day) }}
                          </div>
                    ...
                    <tbody>
                      <tr
                        v-for="room in weeklyData.rooms"
                        :key="room.id"
                        class="border-b border-gray-100 hover:bg-gray-50/60 transition-colors"
                      >
                        <td
                          class="px-3 py-2.5 font-medium text-gray-800 align-top"
                        >
                        ...
                        >
                          <div class="space-y-1.5">
                            <div
                              v-for="b in getBookingsForCell(room.id, day)"
                              :key="b.id"
                              :class="
                                b.status === 'APPROVED'
                            ...
                            >
                              <div
                                class="font-bold text-[11px] leading-tight break-words"
                              >
                                {{ b.event_name }}
                              </div>
                              <div
                                class="text-[10px] opacity-80 mt-0.5 font-medium"
                              >
                                ⏰ {{ b.start_formatted }}–{{ b.end_formatted }}
                              </div>
                            ...
                            <div
                              v-if="
                                getBookingsForCell(room.id, day).length === 0
                              "
                              class="text-gray-300 text-center py-2 text-xs"
                            >
                              —
                            </div>
                          </div>
                ...
                <div v-if="weeklyData" class="md:hidden space-y-4">
                  ...
                  <div class="grid grid-cols-7 gap-1 sm:gap-1.5">
                    ...
                    >
                      ...
                      <span
                        class="text-[10px] uppercase font-medium tracking-tight"
                        :class="
                          selectedMobileDay === day
                            ? 'text-white/90'
                            : 'text-gray-500'
                      ...
                      <div
                        class="flex items-center justify-center gap-0.5 mt-0.5"
                      >
                        <span
                          v-if="getDayBookingCount(day) > 0"
                          :class="
                            selectedMobileDay === day
                              ? 'bg-amber-300'
                              : 'bg-[#882f1d]'
                        ...
                        <span
                          v-else
                          class="w-1.5 h-1.5 rounded-full inline-block opacity-0"
                        ></span>
                      </div>
                    </button>
                  </div>
                  ...
                  <div
                    class="bg-gradient-to-r from-gray-50 to-amber-50/30 border border-gray-200 rounded-xl p-3.5 flex items-center justify-between gap-2"
                  >
                    <div class="flex items-center gap-2.5">
                      <div
                        class="w-2.5 h-2.5 rounded-full bg-[#882f1d] ring-4 ring-[#882f1d]/20 shrink-0"
                      ></div>
                      <div>
                    ...
                    <span
                      v-if="isToday(selectedMobileDay)"
                  ...
                  <div class="space-y-3">
                    <template v-for="room in weeklyData.rooms" :key="room.id">
                      <div
                        v-if="
                          getBookingsForCell(room.id, selectedMobileDay)
                            .length > 0
                        "
                      ...
                      >
                        <!-- Room Header -->
                        <div
                          class="bg-gradient-to-r from-gray-50 to-white px-4 py-2.5 border-b border-gray-100 flex items-center justify-between"
                        >
                          <div class="flex items-center gap-2">
                          ...
                          <span
                            class="text-xs text-gray-600 bg-white px-2.5 py-0.5 rounded-full border border-gray-200 shadow-2xs font-medium"
                          >
                            📍 {{ room.location }}
                          </span>
                        </div>
                        ...
                        <div class="p-3 space-y-2.5">
                          ...
                          >
                            <div class="flex items-start justify-between gap-2">
                              <span
                                class="font-bold text-gray-900 text-sm leading-snug break-words flex-1"
                                >{{ b.event_name }}</span
                              >
                              <span
                                :class="
                            ...
                            <div
                              class="flex flex-wrap items-center justify-between text-xs text-gray-600 pt-2 border-t border-black/5 gap-2"
                            >
                              <span
                                class="flex items-center gap-1.5 text-gray-700 font-medium"
                              >
                                <svg
                              ...
                              <span
                                class="font-bold text-gray-800 bg-white px-2.5 py-1 rounded-lg border border-gray-200 shadow-2xs"
                              >
                                ⏰ {{ b.start_formatted }} –
                                {{ b.end_formatted }} WIB
                              </span>
                    ...
                    <div
                      v-if="
                        weeklyData.rooms &&
                        !weeklyData.rooms.some(
                          (r) =>
                            getBookingsForCell(r.id, selectedMobileDay).length >
                            0,
                        )
                      "
                    ...
                    >
                      <div
                        class="w-12 h-12 rounded-full bg-emerald-100/80 text-emerald-700 flex items-center justify-center mx-auto mb-3"
                      >
                        <svg
                          class="w-6 h-6"
                          fill="none"
                      ...
                      <h4 class="text-sm sm:text-base font-bold text-gray-800">
                        Tidak ada pemesanan ruangan pada hari ini
                      </h4>
                      <p class="text-xs text-gray-500 mt-1 max-w-sm mx-auto">
                        Semua ruangan kosong dan bebas untuk diajukan pemesanan.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <!-- Legend -->
                <div
                  class="flex items-center gap-4 mt-5 pt-3 border-t border-gray-100 text-xs text-gray-500"
                >
                  <div class="flex items-center gap-1.5">
                    <span
                      class="w-3 h-3 rounded-full bg-emerald-400 inline-block"
                    ></span>
                    Disetujui
                  </div>
                  <div class="flex items-center gap-1.5">
                    <span
                      class="w-3 h-3 rounded-full bg-amber-400 inline-block"
                    ></span>
                    Menunggu
                  </div>
                </div>
              ...
              <div class="flex items-center gap-4 my-8">
                <div
                  class="flex-1 h-px bg-gradient-to-r from-transparent via-[#882f1d]/30 to-[#882f1d]/60"
                ></div>
                <div
                  class="flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#882f1d]/30 bg-[#882f1d]/5"
                >
                  <svg
                    class="w-4 h-4 text-[#882f1d]"
                    fill="none"
                  ...
                  <span class="text-sm font-semibold text-[#882f1d] font-cinzel"
                    >Peta Pemesanan</span
                  >
                </div>
                <div
                  class="flex-1 h-px bg-gradient-to-l from-transparent via-[#882f1d]/30 to-[#882f1d]/60"
                ></div>
              </div>

              <!-- Available Rooms -->
              <div
                class="mb-8 w-full overflow-x-hidden scroll-mt-28"
                id="katalog-ruangan"
              >
                <h2
                  class="text-2xl font-cinzel font-semibold text-[#882f1d] mb-6"
                >
                  Ruangan Tersedia
                </h2>
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
                  ...
                  >
                    ...
                    <div class="flex items-start justify-between mb-3">
                      ...
                      <span
                        class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-emerald-100 text-emerald-800 border border-emerald-300 flex-shrink-0 ml-2"
                      >
                        <span
                          class="w-2 h-2 mr-1.5 bg-emerald-500 rounded-full animate-pulse"
                        ></span>
                        Siap Dipesan
                      </span>
                    </div>
                    ...
                    <div
                      v-if="room.is_dedicated"
                      class="mb-4 px-3 py-1.5 bg-amber-50 border border-amber-300 rounded-xl flex items-center gap-1.5 text-xs text-amber-900 font-semibold shadow-xs"
                    >
                    ...
                    <div class="space-y-3 mb-6">
                      ...
                      <div class="flex items-center text-gray-700">
                        <svg
                          class="w-5 h-5 text-[#882f1d] mr-3"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                        ...
                        <span class="text-base"
                          ><strong>{{ room.capacity }}</strong> orang</span
                        >
                      </div>
                      ...
                      <!-- Facilities -->
                      <div
                        v-if="room.facilities"
                        class="flex items-start text-gray-700"
                      >
                        <svg
                          class="w-5 h-5 text-[#882f1d] mr-3 mt-0.5 flex-shrink-0"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                ...
                >
                  ...
                  >
                    <div class="flex justify-between items-start">
                      <div>
                        <h2
                          class="text-2xl font-cinzel font-bold text-gray-800"
                        >
                          Pesan Ruangan
                        </h2>
                        <p
                          class="text-sm text-gray-600 mt-1 flex items-center gap-2 flex-wrap"
                        >
                          ...
                          <span>•</span>
                          <span class="text-[#882f1d] font-medium">{{
                          ...
                          >
                            ...
                            >
                              <path
                                ...
                                stroke-linejoin="round"
                                stroke-width="2"
                                d="M7 7h.01M7 11h.01M7 15h.01M13 7h.01M13 11h.01M13 15h.01M19 7h.01M19 11h.01M19 15h.01M4 21h16a2 2 0 002-2V5a2 2 0 00-2-2H4a2 2 0 00-2 2v14a2 2 0 002 2z"
                              />
                            </svg>
                            Sisa Kuota Anda: {{ userQuota.remaining }} dari
                            {{ userQuota.max_allowed }} pemesanan (Bulan Ini)
                          </span>
                        </div>
                        ...
                        <div
                          v-if="
                            selectedRoom.facilities || selectedRoom.description
                          "
                          class="mt-2.5 text-xs text-gray-500 bg-white p-2.5 rounded-lg border border-gray-200 space-y-1"
                        >
                          <p
                            v-if="selectedRoom.facilities"
                          ...
                          >
                            ...
                            >
                            <span>{{
                              parseFacilities(selectedRoom.facilities).join(
                                ", ",
                              )
                            }}</span>
                          </p>
                          <p
                            ...
                            class="flex items-center gap-1.5 text-amber-700"
                          >
                            <strong class="font-semibold"
                              >⚠️ Tata Tertib:</strong
                            >
                        ...
                        <div
                          v-if="selectedRoom.is_dedicated"
                          class="mt-2.5 p-2.5 bg-amber-100/90 border border-amber-300 rounded-lg text-xs text-amber-950 font-medium flex items-start gap-1.5"
                        >
                          <span class="text-base leading-none">🔒</span>
                          <div>
                            <strong class="font-bold"
                              >Ruangan Hak Pakai Permanen:
                              {{
                                selectedRoom.dedicated_to || "Seksi / Kelompok"
                              }}</strong
                            >
                            <p class="text-[11px] opacity-90 mt-0.5">
                              Pemesanan oleh pihak luar memerlukan persetujuan
                              khusus dari Sekretariat / Admin.
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  <form @submit.prevent="createBooking" class="p-6 space-y-5">
                    ...
                    <div>
                      ...
                      <div class="mt-2.5 flex items-center gap-1.5 flex-wrap">
                        ...
                        <button
                          type="button"
                          @click="applySessionPreset('09:00', '12:00')"
                        ...
                        <button
                          type="button"
                          @click="applySessionPreset('13:00', '16:00')"
                          class="px-2.5 py-1 text-xs font-medium bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-md transition-colors border border-blue-200"
                        >
                          Siang (13:00–16:00)
                        </button>
                        <button
                          type="button"
                          @click="applySessionPreset('19:00', '21:00')"
                    ...
                    <div class="border-t border-gray-200 pt-4">
                      ...
                      >
                        <input
                          v-model="bookingForm.is_recurring"
                          type="checkbox"
                          class="w-4 h-4 text-[#882f1d] rounded border-gray-300 focus:ring-[#882f1d]"
                        />
                        <span>Pemesanan Berulang / Rutin (Recurring)</span>
                      </label>

                      <div
                        v-if="bookingForm.is_recurring"
                        class="mt-3 p-4 bg-amber-50/80 border border-amber-200 rounded-xl space-y-3"
                      >
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                          <div>
                            <label
                              class="block text-xs font-semibold text-gray-700 mb-1"
                              >Frekuensi Pengulangan</label
                            >
                            <select
                              v-model="bookingForm.recurrence_pattern"
                              class="w-full p-2.5 text-sm border border-gray-300 rounded-lg focus:ring-[#882f1d] outline-none bg-white"
                            >
                              <option value="WEEKLY">
                          ...
                          <div>
                            <label
                              class="block text-xs font-semibold text-gray-700 mb-1"
                              >Ulangi Sampai Tanggal (Maks 90 Hari)</label
                            >
                            <input
                              v-model="bookingForm.repeat_until"
                              type="date"
                              :min="bookingForm.event_date"
                              class="w-full p-2.5 text-sm border border-gray-300 rounded-lg focus:ring-[#882f1d] outline-none bg-white"
                            />
                          </div>
                        </div>
                        ...
                        <div
                          v-if="recurringSummaryDates.length > 0"
                          class="mt-2 pt-2 border-t border-amber-200/60"
                        >
                          <p
                            class="text-xs font-bold text-amber-900 mb-1.5 flex items-center gap-1"
                          >
                            <span
                              >ℹ️ Perkiraan
                              {{ recurringSummaryDates.length }} jadwal yang
                              akan dipesan:</span
                            >
                          </p>
                          <div class="flex flex-wrap gap-1">
                            <span
                              v-for="(dt, dIdx) in recurringSummaryDates"
                              :key="dIdx"
                    ...
                    <div
                      ...
                      class="px-4 py-3 bg-amber-50 border border-amber-300 rounded-lg text-sm text-amber-900 flex items-start gap-2.5"
                    >
                      <svg
                      ...
                      <div>
                        <p class="font-bold text-amber-900">
                          Kuota Pemesanan Bulan Ini Habis ({{
                            userQuota.monthly_count
                          }}/{{ userQuota.max_allowed }})
                        </p>
                        <p class="text-xs text-amber-800 mt-0.5">
                          Kategori Anda dibatasi maksimal
                          {{ userQuota.max_allowed }} pemesanan per bulan
                          kalender. Pemesanan baru tidak dapat dibuat untuk
                          bulan ini.
                        </p>
                      </div>
                    </div>
                    ...
                    <div
                      v-if="slotChecking"
                      class="flex items-center gap-2 px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-600"
                    >
                      <svg
                        class="w-4 h-4 animate-spin text-[#882f1d] flex-shrink-0"
                        fill="none"
                        viewBox="0 0 24 24"
                      >
                        <circle
                    ...
                    <!-- Available -->
                    <div
                      v-else-if="slotCheckResult && slotCheckResult.available"
                    ...
                    >
                      ...
                      <span class="font-medium"
                        >Slot waktu tersedia — Anda dapat melanjutkan
                        pemesanan</span
                      >
                    </div>
                    ...
                    <div
                      v-else-if="
                        slotCheckResult && slotCheckResult.soft_conflict
                      "
                    ...
                    >
                      <div class="flex items-start gap-2 mb-2">
                        ...
                        <div>
                          <p class="font-semibold text-yellow-800">
                            Ada pemesanan yang menunggu persetujuan di waktu ini
                          </p>
                          <p class="text-yellow-700 mt-0.5">
                            Anda masih dapat memesan, namun mungkin ada konflik
                            jika disetujui.
                          </p>
                        </div>
                      </div>
                      <ul class="mt-2 space-y-1.5 pl-7">
                        <li
                          v-for="c in slotCheckResult.conflicts"
                          :key="c.id"
                        ...
                        >
                          ...
                          <span>
                            <strong>{{ c.event_name }}</strong> oleh
                            {{ c.requester_name }} — Pukul
                            {{ c.start_formatted }} – {{ c.end_formatted }}
                            <span
                              class="ml-1 px-1.5 py-0.5 bg-yellow-200 text-yellow-800 rounded text-xs font-semibold"
                              >MENUNGGU</span
                            >
                          </span>
                        </li>
                    ...
                    <div
                      v-else-if="
                        slotCheckResult && slotCheckResult.hard_conflict
                      "
                      ...
                      <div class="flex items-start gap-2 mb-2">
                        ...
                        <div>
                          ...
                          <p class="text-red-700 mt-0.5">
                            Silakan pilih waktu atau tanggal lain.
                          </p>
                        </div>
                      </div>
                      <ul class="mt-2 space-y-1.5 pl-7">
                    ...
                    >
                      ...
                      <div>
                        <p class="font-bold text-amber-900">
                          Akses Admin Terdeteksi
                        </p>
                        <p class="text-xs text-amber-800 mt-0.5">
                          Admin tidak dapat membuat booking melalui halaman
                          publik. Gunakan <strong>Admin Panel</strong> untuk
                          membuat dan mengelola pemesanan ruangan.
                        </p>
                        <NuxtLink
                          to="/admin/bookings-new"
                          class="inline-flex items-center gap-1.5 mt-2 text-xs font-semibold text-amber-900 hover:text-amber-700 underline"
                        >
                          <svg
                            class="w-3.5 h-3.5"
                            fill="none"
                    ...
                    <div class="flex gap-3 pt-2">
                      <button
                        ...
                        :title="
                          isCurrentUserAdmin
                            ? 'Admin harus menggunakan Admin Panel untuk booking'
                            : hasQuotaExhausted
                              ? 'Kuota pemesanan Anda bulan ini sudah habis'
                              : hasHardConflict
              ...
              <!-- My Bookings -->
              <div
                class="mb-12 w-full overflow-x-hidden scroll-mt-28"
                id="pemesanan-saya"
              >
                ...
                >
                  <h2 class="text-2xl font-cinzel font-semibold text-[#882f1d]">
                    Pemesanan Saya
                  </h2>
                  ...
                  >
                    ...
                    <span>{{
                      showHistory ? "Kembali ke Aktif" : "Lihat Riwayat"
                    }}</span>
                  </button>
                </div>
                ...
                >
                  ...
                  <p class="text-sm text-blue-800">
                    ...
                    <strong>aktif dan akan datang</strong>. Klik "Lihat Riwayat"
                    untuk melihat semua pemesanan termasuk yang sudah lewat.
                  </p>
                </div>
                <div
                  v-else
                  class="mb-4 bg-gray-50 border border-gray-300 rounded-lg p-3 flex items-start gap-2"
                >
                  <svg
                  ...
                  <p class="text-sm text-gray-700">
                    Menampilkan
                    <strong>semua riwayat pemesanan</strong> termasuk yang sudah
                    selesai.
                  </p>
                </div>
                ...
                <div
                  v-else
                  class="grid md:grid-cols-2 lg:grid-cols-3 gap-4 w-full"
                >
                  <div
                    v-for="booking in paginatedBookings"
                    :key="booking.id"
                    class="group relative bg-white border border-gray-200/90 hover:border-amber-400/80 rounded-2xl shadow-xs hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden cursor-pointer w-full max-w-full flex flex-col justify-between"
                  ...
                  >
                    ...
                    <div
                      ...
                      :class="{
                        ...
                        'bg-gray-300': booking.status === 'CANCELLED' || booking.status === 'COMPLETED'
                      }"
                    ></div>
                    ...
                    <div class="p-5 flex-1 flex flex-col justify-between">
                      <div>
                        <div class="flex justify-between items-start mb-3 gap-2">
                          <h3
                            class="font-bold text-base sm:text-lg text-gray-900 flex-1 leading-snug break-words group-hover:text-[#882f1d] transition-colors"
                          >
                            {{ booking.event_name }}
                          </h3>
                          <div class="flex flex-col gap-1 items-end shrink-0">
                            <!-- Status Badge with Live Pulse for PENDING -->
                            <span
                              v-if="booking.status === 'PENDING'"
                              class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-amber-50 text-amber-800 border border-amber-300 shadow-2xs"
                            >
                            ...
                            <span
                              ...
                              class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-emerald-50 text-emerald-800 border border-emerald-300 shadow-2xs"
                            >
                              <span class="h-2 w-2 rounded-full bg-emerald-500 mr-1.5 inline-block shrink-0"></span>
                              {{ getStatusText(booking.status, booking.start_time, booking.end_time) }}
                            </span>
                            <span
                              v-else-if="booking.status === 'REJECTED'"
                              class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-red-50 text-red-800 border border-red-300 shadow-2xs"
                            >
                              <span class="h-2 w-2 rounded-full bg-red-500 mr-1.5 inline-block shrink-0"></span>
                              {{ getStatusText(booking.status, booking.start_time, booking.end_time) }}
                            </span>
                            <span
                              v-else
                              class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-gray-100 text-gray-700 border border-gray-300"
                            >
                              <span class="h-2 w-2 rounded-full bg-gray-400 mr-1.5 inline-block shrink-0"></span>
                              {{ getStatusText(booking.status, booking.start_time, booking.end_time) }}
                            </span>
                            ...
                            <span
                              v-if="
                                isBookingPassed(booking.end_time) && showHistory
                              "
                              class="px-2.5 py-0.5 rounded-full text-[10px] font-semibold bg-gray-400 text-white"
                            >
                              SELESAI
                            </span>
                            <!-- Badge Pemesanan Berulang / Rutin -->
                            <span
                              v-if="booking.recurrence_pattern"
                        ...
                        <div class="space-y-2 mb-4">
                          <div class="flex items-center text-gray-600 text-sm">
                            <svg
                              class="w-4 h-4 mr-2 text-[#882f1d] shrink-0 group-hover:scale-110 transition-transform duration-200"
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                            >
                        ...
                        <div
                          ...
                          class="bg-red-50 border border-red-200 text-red-700 text-xs px-3 py-2 rounded-xl mb-3 flex items-start gap-1.5"
                        >
                          <span class="text-red-500 font-bold shrink-0">⚠️</span>
                          <span><strong>Alasan penolakan:</strong> {{ booking.rejection_reason }}</span>
                        </div>
                      </div>
                      ...
                      >
                        <span
                          class="text-[#882f1d] text-sm font-semibold flex items-center gap-1 group-hover:translate-x-1 transition-transform"
                        >
                          Lihat Detail <span class="text-base leading-none">→</span>
                        </span>
                        <button
                          v-if="booking.status === 'PENDING'"
                          @click.stop="confirmCancelBooking(booking.id)"
                          class="text-red-600 text-xs font-medium hover:bg-red-50 px-3 py-1.5 rounded-lg border border-red-200 active:scale-95 transition-all"
                        >
                          ✕ Batalkan
                        </button>
                      </div>
              ...
              <div class="w-full max-w-full overflow-x-hidden">
                <h2
                  class="text-xl sm:text-2xl font-cinzel font-semibold text-[#882f1d] mb-4 break-words"
                >
                  Peta Pemesanan Ruangan
                </h2>
                ...
                >
                  ...
                  <template v-else>
                    ...
                    >
                      ...
                      <h3
                        class="text-xl font-bold text-gray-900 truncate flex-1"
                      >
                        {{ room.name }}
                      </h3>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-4 w-full">
                      <div class="min-w-0 bg-gray-50 p-3 rounded-lg">
                        <div
                          class="text-xs text-gray-500 uppercase font-semibold mb-2"
                        >
                          Kapasitas
                        </div>
                        <div
                          class="font-bold text-gray-900 flex items-center text-base"
                        >
                          <svg
                            class="w-5 h-5 mr-2 text-[#882f1d] flex-shrink-0"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
                    ...
                    <div
                      v-if="room.facilities"
                      class="mb-4 pb-4 border-b border-gray-200 w-full overflow-hidden"
                    >
                      <div
                        class="text-xs text-gray-500 uppercase font-semibold mb-2 flex items-center"
                      >
                        <svg
                          class="w-4 h-4 mr-1 text-[#882f1d]"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                      ...
                      <div class="flex flex-wrap gap-2">
                        <span
                          v-for="(facility, index) in parseFacilities(
                            room.facilities,
                          )"
                          :key="index"
                    ...
                    <div class="mb-4">
                      <div class="flex items-center justify-between">
                        ...
                        >
                        <span
                          :class="getAvailabilityStatusClass(room.status)"
                        ...
                        >
                          <span
                            ...
                            :class="{
                              ...
                              'bg-orange-400':
                                room.status === 'Menunggu Persetujuan',
                            }"
                          ></span>
                          {{ room.status }}
                        </span>
                    ...
                    >
                      <button
                        @click="toggleRoomBookings(room.id)"
                      ...
                      >
                        <span class="flex items-center">
                          ...
                          Jadwal Hari Ini
                          <span
                            class="ml-2 px-2 py-0.5 bg-[#882f1d] text-white rounded-full text-xs font-bold"
                          >
                        ...
                        <svg
                          ...
                          :class="{ 'rotate-180': expandedRooms[room.id] }"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                      ...
                      <div
                        v-show="expandedRooms[room.id]"
                        class="space-y-3 mt-2 animate-fade-in w-full"
                      >
                        <div
                        ...
                        >
                          <div
                            class="font-bold text-base text-gray-900 mb-2 break-words"
                          >
                            {{ booking.event_name }}
                          </div>
                          <div
                            class="text-sm text-gray-600 flex items-center mb-3"
                          >
                            <svg
                              class="w-4 h-4 mr-2 text-[#882f1d]"
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                            >
                    ...
                    <div
                      v-else
                      class="text-center py-6 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300"
                    >
                      <svg
                ...
                <!-- Desktop View: Table -->
                <div
                  class="hidden md:block overflow-x-auto w-full table-desktop-only"
                >
                        ...
                        <td class="px-4 py-2 border-b">
                          <div class="flex flex-col">
                            ...
                            >
                              ...
                              <div
                                v-for="booking in room.bookings.slice(0, 3)"
                                :key="booking.id"
                ...
                <!-- Legend -->
                <div
                  class="mt-4 p-4 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg border border-gray-200"
                >
                  <h3
                  ...
                  >
                    <div
                      class="flex items-center bg-white px-3 py-2 rounded-lg shadow-sm"
                    >
                      <span
                        class="w-4 h-4 bg-green-500 rounded-full mr-2.5 flex-shrink-0"
                      ></span>
                    ...
                    >
                      <span
                        class="w-4 h-4 bg-blue-500 rounded-full mr-2.5 flex-shrink-0"
                      ></span>
                    ...
                    >
                      <span
                        class="w-4 h-4 bg-yellow-500 rounded-full mr-2.5 flex-shrink-0"
                      ></span>
                      <span class="font-medium text-gray-700"
                        >Sudah Dipesan</span
                      >
                    ...
                    >
                      <span
                        class="w-4 h-4 bg-orange-500 rounded-full mr-2.5 flex-shrink-0"
                      ></span>
                      <span class="font-medium text-gray-700"
...
const loadWeeklySchedule = async (startDate = "") => {
  ...
  try {
    ...
    const data = await $fetch("/api/bookings/weekly-schedule", {
      query: params,
    });
...
const submitCancellation = async () => {
  ...
  if (
    !cancellationReasonInput.value ||
    cancellationReasonInput.value.trim().length < 5
  ) {
...
const recurringSummaryDates = computed(() => {
  if (
    !bookingForm.value.is_recurring ||
    !bookingForm.value.event_date ||
    !bookingForm.value.repeat_until
  ) {
    return [];
  }
...
const hasHardConflict = computed(
  () => slotCheckResult.value?.hard_conflict === true,
);
  ...
  if (token) {
    ...
    try {
      ...
      if (isAdminAccount && hasAdminSession) {
        console.log(
          "[MOUNTED] Admin user with active session detected (role_id:",
          response.role_id,
      ...
      await Promise.all([loadData(), loadUserQuota(), loadWeeklySchedule()]);
    } catch (error) {
  ...
  try {
    ...
    const isAdminAccount =
      (userResponse.role_id !== null &&
        userResponse.role_id !== undefined &&
        Number(userResponse.role_id) > 0) ||
    ...
    if (isAdminAccount && hasAdminSession) {
      console.log(
        "[Booking Login] Admin user with active session detected (role_id:",
  ...
  try {
    ...
    if (bookingsRes.success && bookingsRes.data) {
      ...
      if (myBookings.value.length > 0) {
        console.log(
          "[LOAD DATA] Sample bookings:",
          myBookings.value.slice(0, 3).map((b) => ({
            id: b.id,
...
const createBooking = async () => {
  ...
  if (bookingForm.value.is_recurring) {
    ...
    if (!repeatUntilTrimmed) {
      bookingError.value =
        "Batas tanggal pengulangan wajib diisi untuk pemesanan rutin";
      bookingLoading.value = false;
      return;
    }
    if (repeatUntilTrimmed <= bookingForm.value.event_date) {
      bookingError.value =
        "Batas tanggal pengulangan harus setelah tanggal acara pertama";
      bookingLoading.value = false;
      return;
    }
    ...
    if (repeatUntilObj > maxFutureDate) {
      bookingError.value =
        "Batas pemesanan berulang maksimal 90 hari (3 bulan) dari tanggal pertama";
      bookingLoading.value = false;
      return;
    }
  }
  ...
  try {
    ...
    const startDateTime = new Date(
      `${bookingForm.value.event_date}T${bookingForm.value.start_time}`,
    );
    const endDateTime = new Date(
      `${bookingForm.value.event_date}T${bookingForm.value.end_time}`,
    );
