      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-2 gap-8 mx-[10%]">
          <div>
            ...
            <p>Jl. Raya Bandara Juanda No.10, Semambung, Kec. Gedangan, Kabupaten Sidoarjo, Jawa Timur 61254</p>
          ...
          <div>
            ...
            <form @submit.prevent="submitForm" class="space-y-4">
              <input v-model="form.name" type="text" placeholder="Nama" class="w-full p-2 border rounded" required />
              <input v-model="form.email" type="email" placeholder="Email" class="w-full p-2 border rounded" required />
              <input v-model="form.phone" type="tel" placeholder="No. HP" class="w-full p-2 border rounded" required />
              <textarea v-model="form.message" placeholder="Pesan" class="w-full p-2 border rounded" rows="4"
                required></textarea>
...
// Page meta
useHead({
  title: 'Kontak Kami - Paroki St. Paulus Juanda',
  meta: [
    { name: 'description', content: 'Hubungi Paroki St. Paulus Juanda untuk informasi dan pertanyaan rohani' }
  ]
})
</script>
