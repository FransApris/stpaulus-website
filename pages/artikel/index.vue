    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="lg:col-span-9">
        ...
        >
          ...
          >
            <!-- Article Image -->
            <div v-if="article.image" class="w-full h-48 bg-gray-200 overflow-hidden">
              <img 
                :src="article.image" 
                :alt="article.title" 
                class="w-full h-full object-cover hover:scale-105 transition-transform duration-300"
                @error="(e) => e.target.src = '/images/default-article.jpg'"
              />
            </div>
            <div v-else class="w-full h-48 bg-gradient-to-br from-[#882f1d] to-[#c58229] flex items-center justify-center">
