  ...
  <div class="min-h-screen pt-16 bg-gray-50">
    <section class="bg-white py-20 border-b border-gray-200">
      <div class="container mx-auto px-4 text-center">
        <h1 class="text-4xl md:text-5xl font-cinzel mb-4 text-[#882f1d]">Galeri Foto</h1>
    ...
    <section class="py-16">
      <div class="container mx-auto px-4">
        ...
        <div v-else-if="albums && albums.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            <!-- Album Thumbnail -->
            <div class="album-preview relative bg-gradient-to-br from-[#882f1d] to-[#6b2416] h-64 flex items-center justify-center">
              <img 
