      ...
      <form @submit.prevent="submitNews" class="space-y-6">
        ...
        <div>
          ...
          <div class="space-y-3">
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3">
              ...
              <button type="button" @click="triggerFileInput" :disabled="uploadingImage"
        ...
        <div class="pt-4 border-t border-gray-200 flex justify-end gap-3">
          <NuxtLink to="/kontributor"
            class="touch-feedback px-5 py-2.5 bg-white border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#882f1d]">
            Batal
          </NuxtLink>
          <button type="submit" :disabled="submitting"
            class="touch-feedback inline-flex items-center justify-center px-5 py-2.5 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-[#882f1d] hover:bg-[#702517] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#882f1d] disabled:opacity-70 disabled:cursor-not-allowed">
