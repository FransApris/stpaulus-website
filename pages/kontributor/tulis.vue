  ...
  <div class="max-w-4xl mx-auto pb-12">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8">
      <form @submit.prevent="submitNews" class="space-y-6">
        ...
        <!-- Gambar Utama -->
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1">URL Gambar Utama</label>
          <p class="text-xs text-gray-500 mb-2">Opsional. Masukkan link gambar atau kosongkan jika tidak ada.</p>
