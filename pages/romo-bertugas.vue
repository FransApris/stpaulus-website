    ...
    <section class="py-8 md:py-16 bg-white">
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="text-center mb-8 md:mb-12">
          <h1 class="text-3xl md:text-4xl font-cinzel text-[#882f1d] mb-3 md:mb-4">Romo-Romo yang Pernah Bertugas</h1>
          <p class="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
            Kami menghormati dan mengenang para Romo yang telah memberikan pelayanan dan dedikasi luar biasa di paroki
            ini.
          </p>
        </div>
